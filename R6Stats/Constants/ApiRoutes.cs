namespace R6Stats.Constants
{
    internal static class ApiRoutes
    {
        ...
        internal const string UbiServicesBaseUrl = "https://public-ubiservices.ubi.com";
        internal const string Sessions = "v3/profiles/sessions";
        internal const string Profiles = "v3/profiles";
        internal const string Progressions = "v1/spaces/{0}/sandboxes/{1}/r6playerprofile/playerprofile/progressions";
        internal const string Ranks = "v1/spaces/{0}/sandboxes/{1}/r6karma/players";
